...
log_msg("Initialized output and logs directories", Level.INFO, file_info())
...
if args.budget_file:
    ...
    log_variable("basename", basename, Level.INFO, file_info())
    log_variable("filepath", filepath, Level.INFO, file_info())
...
if args.checking_balance:
    ...
    log_variable("checking_balance", checking_balance, Level.INFO, file_info())
else:
